...
const handle = function (e, op) {
  if (e.target.classList.contains('nav__link')) {
    const link = e.target;
    const sp = link.closest('.nav').querySelectorAll('.nav__link');
...
// const yaxis = section1.getBoundingClientRect().top;
// window.addEventListener('scroll', function () {
//   if (window.scrollY > yaxis) nav.classList.add('sticky');
